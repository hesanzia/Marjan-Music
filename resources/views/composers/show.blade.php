    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card mb-3">
                <div class="row g-0">
                    <div class="col-md-4">
                        <img src="{{asset($composer->picture)}}" class="img-fluid rounded-start">
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
                            <h4 class="card-title">{{$composer->name}}</h4>
                            <h5 class="card-title">Age : {{$composer->age}}</h5>
                            <p class="card-text">{{$composer->about}}</p>
