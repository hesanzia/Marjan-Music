        ...
        <div class="container">
            <form method="post" action="{{ route('songs.update',$song->id) }}">
                ...
                <div class="">
                    ...
                    <div class="form-group">
                        <label for="singer_id">Singer Name</label>

                        <select class="custom-select" aria-label="Default select example" id="singer_id" name="singer_id">
                    ...
                    <div class="form-group">
                        ...
                        <select class="custom-select" aria-label="Default select example" id="composer_id" name="composer_id">
                    ...
                    <div class="form-group">
                        <label for="producer_id">Producer Name</label>

                        <select class="custom-select" aria-label="Default select example" id="producer_id" name="producer_id">
                    ...
                    <div class="form-group">
                        <label for="songwriter_id">Songwriter Name</label>

                        <select class="custom-select" aria-label="Default select example" id="songwriter_id" name="songwriter_id">
                    ...
                    <div class="form-group">
                        <label for="picture">Upload Cover</label>
                    ...
                    <button type="submit" class="btn btn-custom" style="margin-bottom: 5px"> Edit </button></a>
                </div>
            </form>
        </div>
    </div>
