    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="row g-0">
                    <div class="col-md-4">
                        <img src="{{asset($song->picture)}}" class="img-fluid rounded-start">
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
                            <h3 class="card-title">{{$song->name}}</h3>
                            <a href="{{route('singers.show',$song->singer()->id)}}"><h5 class="card-title">Singer: {{$song->singer()->name}}</h5></a>
                            <a href="{{route('composers.show',$song->composer()->id)}}"><h5 class="card-title">Composer: {{$song->composer()->name}}</h5></a>
                            <a href="{{route('songwriters.show',$song->songwriter()->id)}}"><h5 class="card-title">Songwriter: {{$song->songwriter()->name}}</h5></a>
                            <a href="{{route('producers.show',$song->producer()->id)}}"><h5 class="card-title">Producer: {{$song->producer()->name}}</h5></a>
                            <a class="btn btn-custom" href="{{$song->Link}}">Download</a>
                        </div>
                    </div>
                </div>
            </div>
