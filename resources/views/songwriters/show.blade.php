    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card mb-3">
                <div class="row g-0">
                    <div class="col-md-4">
                        <img src="{{asset($songwriter->picture)}}" class="img-fluid rounded-start">
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
                            <h4 class="card-title">{{$songwriter->name}}</h4>
                            <h5 class="card-title">Age : {{$songwriter->age}}</h5>
                            <p class="card-text">{{$songwriter->about}}</p>
                            <h5 class="card-title">Songs</h5>
                            <div class="row">
                                <div class="col-md-3">
                                    @foreach($songwriter->songs() as $song)
                                        <div class="card" style="width: 100px; margin-top: 5px">
                                            <a href="{{route('songs.show',$song->id)}}"><img src="{{asset($song->picture)}}" class="card-img-top"></a>
                                        </div>
                                    @endforeach
                                </div>
                            </div>
